...
var FormControl_1 = require("react-bootstrap/lib/FormControl");
var InputGroup_1 = require("react-bootstrap/lib/InputGroup");
var Overlay_1 = require("react-bootstrap/lib/Overlay");
var Popover_1 = require("react-bootstrap/lib/Popover");
var Button_1 = require("react-bootstrap/lib/Button");
            ...
            this.props.showTodayButton && React.createElement("tfoot", null,
                React.createElement("tr", null,
                    React.createElement("td", { colSpan: this.props.dayLabels.length, style: { paddingTop: '9px' } },
                        React.createElement(Button_1["default"], { block: true, bsSize: "xsmall", className: "u-today-button", onClick: this.handleClickToday }, this.props.todayButtonLabel)))));
    };
    return Calendar;
}(React.Component));
...
var default_1 = (function (_super) {
    ...
    function default_1(props, context) {
        ...
        _this.handleBlur = function () {
            console.log('handleBlur', _this.state.selectedDate);
        ...
        _this.handleInputChange = function (e) {
            ...
            console.log('handleInputChange', { newValue: newValue, isValid: newValue && newValue.length >= 6 && newDate.isValid() });
        ...
        _this.onChangeDate = function (newSelectedDate) {
            ...
            console.log('onChangeDate', { newSelectedDate: newSelectedDate, inputValue: inputValue });
            _this.setState({
    ...
    default_1.prototype.render = function () {
        ...
        var control = this.props.customControl
            ...
            : React.createElement(FormControl_1["default"], { onKeyDown: this.handleKeyDown, value: this.state.inputValue || '', required: this.props.required, ref: "input", type: "text", className: this.props.className, style: this.props.style, autoFocus: this.props.autoFocus, disabled: this.props.disabled, placeholder: this.state.focused ? this.props.dateFormat : this.state.placeholder, onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleInputChange, autoComplete: this.props.autoComplete });
        return React.createElement(InputGroup_1["default"], { ref: "inputGroup", bsClass: this.props.showClearButton ? this.props.bsClass : '', bsSize: this.props.bsSize, id: this.props.id ? this.props.id + "_group" : null },
            control,
            React.createElement(Overlay_1["default"], { rootClose: true, onHide: this.handleHide, show: this.state.focused, container: function () { return _this.props.calendarContainer || ReactDOM.findDOMNode(_this.refs.overlayContainer); }, target: function () { return ReactDOM.findDOMNode(_this.refs.input); }, placement: this.state.calendarPlacement, delayHide: 200 },
                React.createElement(Popover_1["default"], { id: "date-picker-popover-" + this.props.instanceCount, className: "date-picker-popover", title: calendarHeader },
            ...
            this.props.showClearButton && !this.props.customControl && React.createElement(InputGroup_1["default"].Addon, { onClick: this.props.disabled ? null : this.clear, style: { cursor: (this.state.inputValue && !this.props.disabled) ? 'pointer' : 'not-allowed' } },
